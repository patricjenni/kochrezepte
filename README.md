...
**Note:** This project uses **yarn** as the package manager. See [yarn-commands.md](docs/yarn-commands.md) for a complete command reference.
...
For more yarn commands, see [docs/yarn-commands.md](docs/yarn-commands.md).
